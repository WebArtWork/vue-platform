...
export class AppComponent implements OnInit {
	@ViewChild('textRef', { static: true }) textRef: TemplateRef<any>;
	@ViewChild('dateRef', { static: true }) dateRef: TemplateRef<any>;
	@ViewChild('timeRef', { static: true }) timeRef: TemplateRef<any>;
	@ViewChild('numberRef', { static: true }) numberRef: TemplateRef<any>;
	@ViewChild('emailRef', { static: true }) emailRef: TemplateRef<any>;
	@ViewChild('passwordRef', { static: true }) passwordRef: TemplateRef<any>;
	@ViewChild('buttonRef', { static: true }) buttonRef: TemplateRef<any>;
